<?php
// Define $activeMenu based on the current page or context
$activeMenu = 'dashboard'; // Replace 'dashboard' with the appropriate value

// Include the sidebar HTML code here
?>
<div class="sidebar"> 
    <!-- SidebarSearch Form --> 
